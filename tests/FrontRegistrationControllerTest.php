...
class FrontRegistrationControllerTest extends WebTestCase
{
    public function testRegisterAndConfirmEmail()
    {
        ...
        $this->assertEmailHeaderSame($email, 'subject', 'Bienvenue Emilie Razafimahatratra');
        ...
        $client->followRedirect();
        $crawler = $client->getCrawler();
        $this->assertContains("Alerte succès : Félicitations Emilie Razafimahatratra, votre compte est maintenant activé.", $crawler->filter('#flash_message')->children('div')->first()->text());
